...
import com.sj.common.utils.enums.Week;
...
public class DateUtil {
	...
	public static Date getZeroClock(){
		Calendar calendar = Calendar.getInstance();
	...
	public static Timestamp getTimestamp(long dateLong) {
	...
	public static String getDateStringByLong(long milliseconds) {
        try {
