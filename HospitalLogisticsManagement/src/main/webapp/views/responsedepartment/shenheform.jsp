...
<head id="Head1">
  ...
  <script type="text/javascript" src="../../Js/jquery.easyui.min.js"></script>
    ...
    <body class="easyui-layout" style="overflow-y: hidden" scroll="no">
        <table class="PopUpTableBorder" border="0" cellspacing="0" cellpadding="0">
            <tbody>
             <tr>
                    ...
                    <td width="390px">
                       <label>通过:<input  class= "checkStatus" type="radio" name="tg"  checked="checked" data-value="1"/></label>
                       <label>不通过:<input class= "checkStatus"  type="radio" name="tg" data-value="0"/></label>
                    </td>
                </tr>
                <tr>
                    <td class="PopUpTableTitle" width="150px">
        ...
        <div class="butList">
            <input type="button" name="" value="审核" class="ButtonStyle_Blue" id="check">
        ...
        <script >
        	$(function() {
    			...
    			var url3 = windowPath+'reponse_complete.action';
    			$.post(url3,{'pid':pid,'content':content,'checkStatus':checkStatus},function(data){
